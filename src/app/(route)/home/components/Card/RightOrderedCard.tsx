...
const RightOrderedCard = ({ tag, title, explanation, image }: CardProps) => {
  return (
    <div className="flex h-[417px] w-[344px] flex-col-reverse items-start justify-center gap-6 rounded-xl bg-[#FCFCFC] md:h-[708px] md:w-[696px] lg:h-[444px] lg:w-[988px] lg:flex-row lg:items-center lg:gap-16">
      <div className="flex w-full flex-col items-end gap-3 lg:w-[298px]">
